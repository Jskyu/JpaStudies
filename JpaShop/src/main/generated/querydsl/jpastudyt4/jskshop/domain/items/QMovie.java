...
public class QMovie extends EntityPathBase<Movie> {
    ...
    private static final long serialVersionUID = 1110625550L;
    ...
    //inherited
    public final ListPath<jpastudyt4.jskshop.domain.Category, jpastudyt4.jskshop.domain.QCategory> categories = _super.categories;
